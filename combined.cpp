...
static void Optimize(const ref_vector_t &reference, int wave, char chip)
{
    ...
    case 'L':
        ...
        case 5:
            ...
            break;
        case 6:
            // current score 1526 (105)
            bestparams.threshold = 0.928735673f;
            bestparams.pulsestrength = 2.96852612f;
            bestparams.topbit = 0.f;
            bestparams.distance1 = 0.0854891986f;
            bestparams.distance2 = 0.131530166f;
            break;
        case 7:
            // current score 84 (12)
    ...
    case 'O':
        ...
        case 3:
            ...
            break;
        case 5:
            // current score 6028 (103)
            bestparams.threshold = 0.92815119f;
            bestparams.pulsestrength = 2.29033613f;
            bestparams.distance1 = 1.03258133f;
            bestparams.distance2 = 1.15103722f;
            break;
        case 6:
    ...
    case 'Q':
        ...
        case 7:
            // current score 38 (14)
            bestparams.threshold = 0.902534127f;
            bestparams.pulsestrength = 0.934687853f;
            bestparams.topbit = 0.001f;
            bestparams.distance1 = 1.0594579f;
            bestparams.distance2 = 1.11050117f;
            bestparams.stmix = 0.617700636f;
            // current score 64 (3)
